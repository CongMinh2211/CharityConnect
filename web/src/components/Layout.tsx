import { CircleCheck, HeartHandshake, LogOut, Sparkles, X } from "lucide-react";
...
export function Layout(): JSX.Element {
  ...
  return (
    <div className="min-h-screen">
      {isMockMode && <div className="bg-ink px-4 py-2 text-center text-xs font-semibold text-white"><span className="inline-flex items-center gap-1.5"><Sparkles size={14} className="shrink-0 text-brand-500" /> Chế độ mô phỏng <span className="hidden sm:inline">· dữ liệu được lưu ngay trên trình duyệt</span></span></div>}
